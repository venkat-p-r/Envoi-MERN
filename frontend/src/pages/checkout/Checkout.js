...
const Checkout = ({history}) => {
    ...
    const [country, setCountry] = useState(shippingAddress.country||'Tamil Nadu')
                ...
                <div className="info-check">
                    ...
                    <div className="billing-check">
                        ...
                        <Stack spacing={3}>
                            ...
                            <Select required variant="flushed" onChange = {(e) => setCountry(e.target.value)} >
                    ...
                    <div className="payment-check">
                        ...
                        <input required onChange = {(e)=> { setPayment('Cash on Delivery')}} type="radio" name="COD" id="COD"/><label for="paypal" className="this-label">Cash on Delivery</label>
