...
import {RiShoppingCart2Line,MdSearch,BsArrowRightShort,MdKeyboardArrowRight,IoLogOutOutline,CgProfile, IoChevronDownCircleOutline, IoMdArrowDropdown} from "react-icons/all"
       ...
       <nav ref = {Nav}  className={`nav ${nav ? 'active' : ''}`} >
           <div className="logo"><Link to =''><img src={Logo} alt="Logo" /></Link></div>
            <ul className="navLinks" ref= {navLinks}>
                <NavLink to="/" exact  activeClassName='activlink' onClick = {onBurgActive}><li>Home</li></NavLink>
                <NavLink to="/shop" activeClassName='activlink' onClick = {onBurgActive}><li>Shop</li></NavLink>
                <NavLink to="/contactus"activeClassName='activlink' onClick = {onBurgActive} ><li>Contact us</li></NavLink>
                <NavLink to="/about" activeClassName='activlink' onClick = {onBurgActive}><li>About</li></NavLink>  
            </ul>
